...
class TurtleClient(Node):
    def __init__(self):
        ...
        self.declare_parameter('turtleColor', 'blue', ParameterDescriptor(description='default display color'))
        turtleColor = self.get_parameter('turtleColor').get_parameter_value().string_value
        self.turtle_display.color(turtleColor)
        
        self.declare_parameter('penSize', 3, ParameterDescriptor(description='default pen size'))
