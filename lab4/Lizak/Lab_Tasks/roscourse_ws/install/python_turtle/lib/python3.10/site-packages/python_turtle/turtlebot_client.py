...
class TurtleClient(Node):
    def __init__(self):
        ...
        # Declare turtle color parameter
        self.declare_parameter(
            'turtleColor',
            'red',
            ParameterDescriptor(description='Color used to draw the turtle path')
        )
        ...
        self.declare_parameter(
            'penSize',
            3,
            ParameterDescriptor(description='Thickness of the turtle pen')
        )
...
def main(args=None):
    ...
    while rclpy.ok():
        ...
        # Commented out by Jacob Lizak 3/6/2026
